...
/* -------------------------------------------------
   Custom Modal (soft blurred backdrop, click-outside,
   Escape-key close, smooth animations)
   ------------------------------------------------- */
...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      {/* Backdrop – blurred, semi-transparent, clickable */}
      <div
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex gap-3 justify-end">
          {type === "confirm" && (
            <button
              onClick={onCancel}
              className="px-5 py-2.5 text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200 transition font-medium text-sm"
            >
              {cancelText}
            </button>
          )}
...
const DraftsPage: React.FC = () => {
  ...
  const handleDeleteConfirm = async (id: string) => {
    try {
      ...
      openErrorModal("Failed to delete draft. Please try again.");
    }
  };
  ...
  return (
    <>
                ...
                {data.data.map((draft) => (
                  ...
                  >
                    ...
                    <div className="p-4 bg-gray-50 flex gap-2">
                      ...
                      <button
                        onClick={() => openConfirmModal(draft.id, draft.name)}
      ...
      <Modal
        ...
        cancelText={modal.type === "confirm" ? "Cancel" : undefined}
